...
1. Clone o repositório
  * `git clone git@github.com:danielmlduarte/project-todo-list.git`
...
3. Crie uma branch a partir da branch `master`
  ...
  * Agora, crie uma branch onde você vai guardar os `commits` do seu projeto
    ...
    * Exemplo: `git checkout -b bereu-todo-list-project`

4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
  * Verifique que você está na raiz do projeto
    * Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/joaozinho/code/**project-todo-list**_
...
6. Adicione a sua branch com o novo `commit` ao repositório remoto
  * Usando o exemplo anterior: `git push -u origin bereu-todo-list-project`

7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/danielmlduarte/project-todo-list/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/danielmlduarte/project-todo-list/pulls) e confira que o seu _Pull Request_ está criado
